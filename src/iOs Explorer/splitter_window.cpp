...
BOOL CSplitterWindow::BindWithControl(CWnd *parent, DWORD ctrlId)
{
    m_Parent = parent;
...
void CSplitterWindow::Unbind(void)
{
    DetachAllPanes();
    UnsubclassWindow();
}

void CSplitterWindow::SetMinWidth(int left, int right)
{
    m_minLeft = left;
    m_minRight = right;
}

BOOL CSplitterWindow::AttachAsLeftPane(DWORD ctrlId)
{
    m_leftIds.Add(ctrlId);
    return TRUE;
}

BOOL CSplitterWindow::AttachAsRightPane(DWORD ctrlId)
{
    m_rightIds.Add(ctrlId);
    return TRUE;
}

BOOL CSplitterWindow::DetachAllPanes(void)
{
    m_leftIds.RemoveAll();
...
BOOL CSplitterWindow::GetMouseClipRect(LPRECT rectClip, CPoint point)
{
...
BEGIN_MESSAGE_MAP(CSplitterWindow, CWnd)
...
BOOL CSplitterWindow::OnSetCursor(CWnd* /*pWnd*/, UINT /*nHitTest*/, UINT /*message*/) 
{
...
void CSplitterWindow::OnLButtonDown(UINT /*nFlags*/, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
