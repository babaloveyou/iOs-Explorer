#ifndef IOS_EXPLORER_IEWRAPPER_H_
#define IOS_EXPLORER_IEWRAPPER_H_

class CIEWrapper : public CWnd
{
public:
	...
	void SetCharset(LPTSTR charset);

	DECLARE_MESSAGE_MAP()
	afx_msg void OnUtf8();
	afx_msg void OnUtf32();
	afx_msg void OnUtf16();
	afx_msg void OnGb2312();
	afx_msg void OnGb18030();
	afx_msg void OnGbk();
	afx_msg void OnHz();
	afx_msg void OnBig5();
	afx_msg void OnBig5hk();
	afx_msg void OnEuctw();
	afx_msg void OnIso2022cn();
	afx_msg void OnIso88591();
	afx_msg void OnMacroman();

protected:
	DECLARE_DYNCREATE(CIEWrapper)
	
};

#endif // IOS_EXPLORER_IEWRAPPER_H_
